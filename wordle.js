...
const box1 = document.getElementsByClassName("guess1");
const box2 = document.getElementsByClassName("guess2");
const box3 = document.getElementsByClassName("guess3");
const box4 = document.getElementsByClassName("guess4");
const box5 = document.getElementsByClassName("guess5");
const box6 = document.getElementsByClassName("guess6");
...
// add event listener for each letter
for (let letter of letters) {
  letter.addEventListener("click", function () {
    chars.push(letter.innerHTML);
    chars.forEach((char, i) => {
      currentRow[rowIdx][i].innerHTML = char;
    });
  });
}
...
function checkAnswer() {
  ...
  enterBtn.addEventListener("click", function () {
    ...
    if (chars.length < 5) {
      ...
      if (!validWords.includes(chars.join(""))) {
        alert("Sorry, your word not in the list.");
        return;
      }
      ...
      chars.forEach((char, i) => {
        if (answerCopy[i] === char) {
          ...
          if (!currentRow[rowIdx][i].classList.contains("green")) {
            currentRow[rowIdx][i].classList.add("orange");
          }
        } else {
